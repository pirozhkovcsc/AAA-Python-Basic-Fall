...
class TestWhatIsYearNow(unittest.TestCase):
    ...
    def test_year_format_ymd(self, mock_urlopen):
        ...
        mock_urlopen.return_value.__enter__.return_value.read.return_value = json.dumps(mock_response)

        expected_year = 2023
        self.assertEqual(what_is_year_now(), expected_year, "Должен вернуть год из формата YYYY-MM-DD")
    ...
    def test_year_format_dmy(self, mock_urlopen):
        ...
        expected_year = 2020
        self.assertEqual(what_is_year_now(), expected_year, "Должен вернуть год из формата DD.MM.YYYY")
